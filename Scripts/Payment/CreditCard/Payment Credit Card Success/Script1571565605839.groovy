...
Mobile.setText(findTestObject('Object Repository/Credit Card Midtrans Page/form_card_number_creditcardpage'), '4811111111111114', 
    30)

'Fill the credit card expiration'
Mobile.setText(findTestObject('Object Repository/Credit Card Midtrans Page/form_masa_berlaku_creditcardpage'), '1219', 30)

'Fill the credit card cvv'
Mobile.setText(findTestObject('Object Repository/Credit Card Midtrans Page/form_cvv_creditcardpage'), '123', 30)
...
//'Get Order no in Payment success page'
//def orderNo = Mobile.getText(findTestObject('Object Repository/Payment Success Page/tv_orderno_paymentsuccesspage'), 30)
//def t = orderNo.substring(10)
//System.out.println("HAHAHA: ", t)
//
//'Get Total price in Payment success page'
//def totalPrice = Mobile.getText(findTestObject('Object Repository/Payment Success Page/tv_totalharga_paymentsuccesspage'), 30)
